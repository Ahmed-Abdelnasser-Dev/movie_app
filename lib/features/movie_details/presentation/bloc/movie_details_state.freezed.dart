...
extension MovieDetailsStatePatterns on MovieDetailsState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(MovieDetails movieDetails, bool isOffline)? success,
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Success() when success != null:
        return success(_that.movieDetails, _that.isOffline);
      case _Error() when error != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(MovieDetails movieDetails, bool isOffline)
        success,
...
class _Success implements MovieDetailsState {
  const _Success({required this.movieDetails, required this.isOffline});
  ...
  @override
  int get hashCode => Object.hash(runtimeType, movieDetails, isOffline);

  @override
  String toString() {
    return 'MovieDetailsState.success(movieDetails: $movieDetails, isOffline: $isOffline)';
  }
}
...
abstract mixin class _$SuccessCopyWith<$Res>
  ...
  @useResult
  $Res call({MovieDetails movieDetails, bool isOffline});
}
